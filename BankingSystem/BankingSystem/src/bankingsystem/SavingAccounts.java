 ...
 * @author ACER
 */
public class SavingAccounts extends javax.swing.JFrame {
    String path=null;
    String path2=null;
    

    /**
     * Creates new form SavingAccounts
     */
    public SavingAccounts() {
        initComponents();
        setLocation(150,5);
        setSize(1060,750);
        setTitle("SavingsAccount");
    ...
    private void initComponents() {
        ...
        panel1.setMaximumSize(new java.awt.Dimension(1060, 700));
        panel1.setPreferredSize(new java.awt.Dimension(1060, 700));
        panel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("PERSONAL INFORMATION");
        panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 66, 250, 30));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("FULL NAME :");
        panel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 106, 120, 30));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("DATE OF BIRTH :");
        panel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 166, 150, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("CONTACT INFORMATION");
        panel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 209, 260, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("EMAIL ADDRESS :");
        panel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 248, 160, 30));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("CONTACT NUMBER :");
        panel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 324, 180, 30));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("FULL ADDRESS :");
        panel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 408, 150, -1));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("SAVING ACCOUNT ");
        panel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 330, 40));

        jLabel14.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("ANNUAL INCOME :");
        panel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 518, 180, 30));
        ...
        panel1.add(edtFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, 240, 30));
        ...
        panel1.add(edtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 250, 240, 30));

        edtPan.setBackground(new java.awt.Color(204, 204, 204));
        edtPan.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        panel1.add(edtPan, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 70, 240, 30));

        edtAadhar.setBackground(new java.awt.Color(204, 204, 204));
        edtAadhar.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        panel1.add(edtAadhar, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 120, 240, 30));
        ...
        panel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(988, 0, -1, 30));

        jLabel28.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel28.setForeground(new java.awt.Color(255, 255, 255));
        jLabel28.setText("PAN NUMBER :");
        panel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 70, 168, 30));

        jLabel29.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(255, 255, 255));
        jLabel29.setText("AADHAR NUMBER :");
        panel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 120, -1, 30));
        ...
        panel1.add(edtContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(208, 327, 240, 30));
        ...
        panel1.add(edtDob, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 240, 30));
        ...
        panel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(208, 408, 240, -1));

        edtIncome.setBackground(new java.awt.Color(204, 204, 204));
        panel1.add(edtIncome, new org.netbeans.lib.awtextra.AbsoluteConstraints(208, 519, 240, 30));

        jLabel15.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("USERNAME : ");
        panel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, 130, -1));

        edtUsername.setBackground(new java.awt.Color(204, 204, 204));
        panel1.add(edtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 180, 240, 30));

        jLabel16.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("PASSWORD :");
        panel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 120, 30));
        ...
        panel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, -1, 5));
        ...
        panel1.add(edtSet, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 390, 135, 135));
        ...
        panel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 600, 100, 30));

        edtPassword.setBackground(new java.awt.Color(204, 204, 204));
        panel1.add(edtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 240, 240, 30));
        ...
        panel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 360, 80, 25));

        edtaccn.setEditable(false);
        edtaccn.setBackground(new java.awt.Color(204, 204, 204));
        panel1.add(edtaccn, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 320, 240, 31));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ACCOUNT NUMBER :");
        panel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 320, -1, 31));
        ...
        panel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 600, 100, 30));
        ...
        panel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(471, 646, 120, 30));
        ...
        panel1.add(chkShowPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 280, -1, -1));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO savings (account_number, fullname, dob, email, contact, address, pan, aadhar, income, username, password, usertype) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            pstmt.setLong(1, Long.parseLong(edtaccn.getText())); 
            pstmt.setString(2, edtFullName.getText());  
            pstmt.setString(3, edtDob.getText()); 
            pstmt.setString(4, edtEmail.getText());  
            pstmt.setLong(5, Long.parseLong(edtContact.getText()));  
            pstmt.setString(6, edtAddress.getText());  
            pstmt.setString(7, edtPan.getText());
            pstmt.setLong(8, Long.parseLong(edtAadhar.getText())); 
            pstmt.setInt(9, Integer.parseInt(edtIncome.getText()));  
            pstmt.setString(10, edtUsername.getText()); 
            pstmt.setString(11, edtPassword.getText()); 
            pstmt.setString(12, "savings");  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (f != null) {
            ...
            try {
                ...
                Logger.getLogger(SavingAccounts.class.getName()).log(Level.SEVERE, null, ex);
...
if ((email.contains("@gmail.com") || email.contains("@yahoo.com")) && email.indexOf("@") < email.lastIndexOf(".")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SavingAccounts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SavingAccounts().setVisible(true);
            }
        });
    }
